(function () {
	 ...
	 */
	var URL = './videos.json'; // const URL = 'https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson';
	...
	function loadVideoPage(data) {
	  ...
	  var videoUrl = getvideoUrlfromId(data);
	  ...
	  try {
	    for (_iterator.s(); !(_step = _iterator.n()).done;) {
	      ...
	      if (parseInt(video.id) === parseInt(id)) {
	        //TODO: staðfesta að if condition virkar
	...
	document.addEventListener('DOMContentLoaded', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	  var data, loading, parent, currentPage, videos, categories, div;
	  return regeneratorRuntime.wrap(function _callee$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
